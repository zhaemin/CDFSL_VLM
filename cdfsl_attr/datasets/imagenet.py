...
class ImageNet(DatasetBase):
    ...
    def __init__(self, root, num_shots, setting="standard", seed=1):
        ...
        print("Setup for setting {}".format(setting))
        if setting == "base2new":
            ...
            train, val, test_base, test_new = train_base, test_base, test_base, test_new
        else:
            train, val, test_base, test_new = train, test, test, None
